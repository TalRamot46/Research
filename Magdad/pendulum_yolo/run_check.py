...
def main(argv: list[str] | None = None) -> int:
    ...
    # Default model path is relative to the repository root (no leading backslash)
    p.add_argument("--model", default="runs_pendulum/pendulum_yolo5/detect/weights/best.pt")
    ...
    # Resolve model path: if relative, make it absolute relative to repo root
